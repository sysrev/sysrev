(ns sysrev.views.main
  (:require [reagent.core :as r]
            ...
            [sysrev.views.panels.landing_pages.lit-review]
            [sysrev.views.panels.landing_pages.data-extraction]
            [sysrev.views.panels.landing_pages.managed-review]
            [sysrev.views.panels.landing_pages.systematic-review]
