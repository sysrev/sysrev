...
(deftest ^:e2e ^:stripe test-plans-page
...
(deftest ^:e2e ^:stripe test-plans-page-validation
  (e/with-test-resources [{:keys [driver system] :as test-resources} {}]
    (let [user (test/create-test-user system)]
      (create-customer! user)
      (account/log-in test-resources user)
...
(deftest ^:e2e ^:stripe test-card-declined
  (e/with-test-resources [{:keys [driver system] :as test-resources} {}]
    (let [user (test/create-test-user system)]
      (create-customer! user)
      (account/log-in test-resources user)
...
(deftest ^:e2e ^:stripe test-processing-error
  (e/with-test-resources [{:keys [driver system] :as test-resources} {}]
    (let [user (test/create-test-user system)]
      (create-customer! user)
      (account/log-in test-resources user)
